                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <button class="btn btn-primary btn-sm "
                                                ...
                                                <span class="btn-icon icofont-ui-edit "> Update</span>
                                            </button>
                                            @else
                                            <button class="btn btn-primary btn-sm "
                                                wire:click="editSubscription({{ $subscription->id }}, 'view')">
                                                <span class="btn-icon icofont-eye "> View</span>
                                            </button>
                                            @endif
                                        </div>
                                    </td>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <select class="form-control rounded @error('package_id') is-invalid @enderror"
                                ...
                                @if($showEditModal) @if ($state['status'] !='3' ) disabled @endif @endif>
                        ...
                        <div class="form-group">
                            <input class="form-control rounded @error('payment_ref') is-invalid @enderror" type="text"
                                ...
                                placeholder="Payment Reference" @if($showViewModal) disabled @endif>
                            @error('payment_ref')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
